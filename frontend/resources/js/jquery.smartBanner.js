...
function SmartBanner(parameters){
	...
	*/
	...
	if( force == "ios" && window.location.search.indexOf('=') == -1){
    	$(html).appendTo('body');
	...
	if( force == "android" && window.location.search.indexOf('=') == -1){
    	$(html).appendTo('body');
		BannerPosition(position);
	...
	if( force == "windows" && window.location.search.indexOf('=') == -1){
    	$(html).appendTo('body');
		BannerPosition(position);
	...
	else if(force == null && $.cookie('SmartBanner') != 'seen' && window.location.search.indexOf('=') == -1){
	...
	else if(isMobile.iOS() && ios == "true" && !isStandalone() && window.location.search.indexOf('=') == -1)
	{
	...
	else if(isMobile.Windows() && windows == "true" && !isStandalone() && window.location.search.indexOf('=') == -1){
...
$('#SBlink').on('click', function(){
	...
	if(mode == "web-app" && window.location.search.indexOf('=') == -1){
